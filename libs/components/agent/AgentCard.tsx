            ...
            <Stack className={`agentCard fade-in-up`} style={{ animationDelay: `6s` }}>
                ...
                <Stack className="card-footer">
                    ...
                    <Stack className="card-statistics">
                        <Box  onClick={() => likeMemberHandler(user, agent?._id)}>
                        ...
                        <Box><RemoveRedEyeIcon className="icon"/>{agent?.memberViews}</Box>
                        <Box><ContentPasteIcon className="icon"/>{agent?.memberProperties}</Box>
                    </Stack>
                </Stack>
            </Stack>
        );
