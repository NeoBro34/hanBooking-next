	...
	const tabChangeHandler = async (event: any, newValue: string) => {
		...
		switch (newValue) {
			case 'ACTIVE':
				...
				break;
			case 'PAUSED':
				setPropertiesInquiry({ ...propertiesInquiry, search: { propertyStatus: PropertyStatus.PAUSED } });
				break;
			case 'DELETE':
					...
					<TabContext value={value}>
						<Box component={'div'}>
							<List className={'tab-menu'}>
								...
								<ListItem
									onClick={(e: any) => tabChangeHandler(e, 'PAUSED')}
									value="PAUSED"
									className={value === 'PAUSED' ? 'li on' : 'li'}
								>
									Paused
								</ListItem>
								<ListItem
