...
import { ChatsCircle, Headset, User, UserCircleGear, NoteBlank } from 'phosphor-react';
...
const AdminMenuList = (props: any) => {
	...
	const menu_set = [
		...
		{
			title: 'Bookings',
			icon: <NoteBlank size={20} color="#bdbdbd" weight="fill" />,
			on_click: () => subMenuChangeHandler('Bookings'),
		},
		{
			title: 'Community',
